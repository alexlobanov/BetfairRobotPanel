...
namespace RobotWebPanel.App_Start
{
    ...
    public class ApplicationUserManager : UserManager<AspNetUsers>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AspNetUsers>(context.Get<ModelContext>()));
    ...
    public class ApplicationSignInManager : SignInManager<AspNetUsers, string>
    {
